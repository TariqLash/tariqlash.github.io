  ...
  return (
    <div className='h-screen flex flex-col items-center justify-center hero' >
      <div className='mb-80 md:mb-40'>
        ...
        <div className='flex flex-col items-center text-md md:text-lg mb-5'>
          <p>Tariq Lashley</p>
          <p className='text-muted-foreground'>Full-Stack Developer</p>
        </div>
        <div className='playfair flex flex-col items-center text-5xl md:text-6xl lg:text-8xl text-center'>
