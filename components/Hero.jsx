  ...
  return (
    <div className='h-screen flex flex-col items-center justify-center hero' >
      <div className='mb-40'>
        ...
        <div className='flex flex-col items-center text-lg mb-5'>
          <p>Tariq Lashley</p>
          <p className='text-muted-foreground'>Full-Stack Developer</p>
        </div>
        <div className='playfair flex flex-col items-center text-5xl lg:text-8xl text-center'>
          <p>I build web apps</p>
          <p>that solve real world</p>
          <span className='bg-red-500/50'>problems</span>
        </div>
        <div className='mt-5 flex justify-center text-lg text-muted-foreground'>
